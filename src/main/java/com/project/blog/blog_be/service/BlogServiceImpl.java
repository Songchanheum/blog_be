...
public class BlogServiceImpl implements BlogService {
  ...
  static String apiKey =
    "Bearer secret_1Eg9kSfYrb30eK6V4Gwco9ktsa17wOz85wVHJviGzW4";
  ...
  @Override
  public Map<String, Object> getBlogPostList(
    String tag,
    String category,
    String cursor
  ) throws Exception {
    ...
    if (StringUtils.hasLength(cursor) && !"undefined".equals(cursor) && !"null".equals(cursor)) {
      filterVo.put("start_cursor", cursor);
    }

    filterVo.put("page_size", 8);

    List<Map<String,Object>> sortList = List.of(Map.of("property", "date", "direction", "descending"));
    filterVo.put("sorts", sortList );
    System.out.println(filterVo);

    // api 요청
    Map<String, Object> response = webClient
      .post()
      .uri(uriBuilder -> uriBuilder.path("databases/" + dbId + "/query").build()
      )
      .bodyValue(filterVo)
      .retrieve()
  ...
  @Override
  public Map<String, Object> getBlogPost(String id){

    // api 요청
    Map<String, Object> response = webClient
      .get()
      .uri(uriBuilder -> uriBuilder.path("pages/" + id ).build()
      )
      .retrieve()
      .bodyToMono(Map.class)
      .block();
  ...
  public List<Object> getCategories() {
    ...
    Map<String, Object> response = webClient
      .get()
      .uri(uriBuilder -> uriBuilder.path("databases/" + dbId).build())
      .retrieve()
      .bodyToMono(Map.class)
      .block();

    Map<String, Map<String, Map<String, List<Object>>>> props = objectMapper.convertValue(
      response.get("properties"),
      Map.class
    );
    List<Object> categories = props
      .get("category")
      .get("select")
      .get("options");
